...
export const WELCOME_GENERAL_2 = i18n.translate(
  ...
  {
    defaultMessage:
      "First things first, we'll need to set up an OpenAI Connector to get this chat experience going! With the OpenAI Connector, you'll be able to configure access to either an Azure OpenAI Service or OpenAI API account, but you better believe you'll be able to deploy your own models within your Elastic Cloud instance and use those here in the future... 😉",
  }
);
