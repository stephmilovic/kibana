...
const LLM_TYPE = 'ActionsClientChatBedrock';

interface ActionsClientChatBedrockParams {
...
export const BedrockLlm = new BedrockChat({
  maxTokens: 4096,
  streaming: true,
  region: 'us-east-1',
...
/**
 * This class is a wrapper around the ChatBedrock class from @langchain/openai.
 ...
 * In the ChatBedrock class, *_streamResponseChunks calls completionWithRetry
 * and iterates over the chunks to form the response.
 */
// export class ActionsClientBedrockChat extends BedrockChat {
...
//   // ChatBedrock class needs these, but they do not matter as we override the openai client with the actions client
//   azureOpenAIApiKey = '';
//   openAIApiKey = '';
//
//   // Kibana variables
...
//     maxRetries,
//     signal,
//   }: ActionsClientChatBedrockParams) {
//     super({
//       maxRetries,
//       streaming: true,
