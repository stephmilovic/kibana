  ...
  private getContentsForTab() {
    switch (this.state.selectedTabId) {
      case 'dashboardEmbeddable': {
        return null; // <DashboardContainerExample getEmbeddableFactory={this.props.getEmbeddableFactory} />;
      }
      case 'customContainer': {
        return null; // <CustomContainerExample getEmbeddableFactory={this.props.getEmbeddableFactory} />;
      }
    }
  }
}
